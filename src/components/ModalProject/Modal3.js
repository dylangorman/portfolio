...
export const Modal3 = ({ showModal3, setShowModal3 }) => {
  ...
  return (
    <>
      {showModal3 ? (
        <Background ref={modalRef} onClick={closeModal3}>
          <animated.div style={animation}>
            <ModalWrapper showModal3={showModal3}>
              <ModalImg
                src={require("./drumKit.jpg")}
                alt="drum kit app on laptop"
              />
              <ModalContent>
                <h1>Drum Kit</h1>
                <p>
                  This project was created using html, css and js event
                  listeners and jsDOM. .{" "}
                </p>
                <a
                  href="https://dylangorman.github.io/DRUM-KIT/"
                  target="_blank"
                  rel="noreferrer"
                >
                  View App
                ...
                <br></br>
                <a
                  href="https://github.com/dylangorman/DRUM-KIT"
                  target="_blank"
                  rel="noreferrer"
                >
                  View Code
