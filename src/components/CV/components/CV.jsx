      ...
      <div className="cv-page">
        ...
        <div className="cv-profile">
          ...
          <p>
            ...
            completed a 12-week Master Coding Course and I am looking to start a
            new career path after being made redundant from my previous
            ...
            BootStrap and Node. and learning principles like Agile using systems
            like Kanban/Trello. I have also learnt about backend databases using
            Mongo DB, SQL, Express and have some experience with programmes such
            as D-Beaver and Insomnia. Most of the course was learnt using
            VS-Code using Git and Git Hub. The last 2 weeks of the course we had
            to create, design, and produce a working Full Stack app. The small
            team I was in produced an original App which I led the design side.
            I have a great passion for UI and UX product design and would like
            to further this passion into a long-term career.
          </p>
        </div>
        <br></br>
        <br></br>
        ...
        <div className="cv-experience">
          ...
          <ul>
            <li>
              Assisting the Department Head on daily tasks such as managing use
              of Visual equipment, making sure all equipment is available and
              when not then Sub Hires are in place communicating with several AV
              companies.{" "}
            </li>
            <li>
              Checking in with the service department to make sure all faulty
              Visual equipment is scheduled to be fixed before certain dates and
              tours.{" "}
            </li>
            <li>
              Overseeing the Video Warehouse to make sure all equipment has been
              prepped and de-prepped properly.{" "}
            </li>
            <li>
              Having daily Meetings with the office and warehouse to make sure
              all equipment is accounted for and ready to go out with engineers
              to conferences, concerts, tours etc.{" "}
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Having daily meetings with the other warehouse managers and office
              staff, making sure each day the needed equipment for each event is
              ready to be loaded into necessary vans and lorries, working on
              many shows at once on very tight deadlines.
            </li>
          </ul>
          <h5>Video Warehouse Assistant | Jan 2017- Dec 2018</h5>
          <ul>
            <li>Follow instructions given to me from the warehouse manager.</li>
            <li>
              Making sure all equipment is working properly and raise service
              tickets for faulty items.
            </li>
            <li>
              Assisting loading vans and lorries with the correct equipment for
              each event.
            </li>
          </ul>
