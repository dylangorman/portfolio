...
export const homeObjTwo = {
  ...
  headline: "Code",
  description:
    "I have completed a 12 week Full Stack Boot Camp Course mainly studying and praticing HTML, CSS and Javascript. Alongside using Libraries and Frameworks such as React, BootStrap and Node. and learning principles like Agile using systems like Kanban and Trello. I have also learnt a lot of Backend databases using Mongo DB, SQL, Express and have some experience with programs such as D-Beaver and Insomnia. Most of the course was learnt using VS-Code, Git and GitHub.   ",
  buttonLabel1: "Projects →",
  imgStart: true,
  img: Icon1,
